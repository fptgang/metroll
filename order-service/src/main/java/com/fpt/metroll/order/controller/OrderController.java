...
public class OrderController {
    ...
    public ResponseEntity<Map<String, String>> checkoutSaga(
        ...
        return ResponseEntity.accepted()
                .body(Map.of(
                    "sagaId", sagaId,
                    "status", "STARTED",
                    "message", "Checkout process initiated. Use /orders/saga/{sagaId}/status to track progress."
                ));
    }
    ...
    public ResponseEntity<String> confirmWebhook(
            @Parameter(description = "Webhook URL to confirm", name = "webhookUrl")
            @RequestParam(name = "webhookUrl")
            String webhookUrl
    ) {
