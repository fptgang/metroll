...
public interface AccountClient {
    ...
    @GetMapping("/accounts/basic/{accountId}")
    @Cacheable(cacheNames = "accounts-basic", key = "#accountId")
    AccountBasicDto getAccountBasic(@PathVariable("accountId") String accountId);
}
